    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255)),
                ('category', models.CharField(choices=[('mobile_accessory', 'Mobile Accessory'), ('electronics', 'Electronics'), ('smartphones', 'Smartphones'), ('modern_tech', 'Modern Tech')], max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Deal',
